...
$query = "SELECT * FROM tb_history INNER JOIN tb_shared ON tb_history.fd_id = tb_shared.fdPostId WHERE fdRecever='" . $user_email . "'";
                            ...
                            <div class="col-md-12 headText">
                                <div class="px-2 mx-2" style="background-color:0;">
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <span class="float-right mt-4" style="font-size: 12px;"><?php echo date("d/m/Y", strtotime($date)); ?>
...
<?php } else { ?>
    <div class="container" style="margin-top: 80px;">
        <h1 class="text-secondary text-center">No Shared Post</h1>
    </div>
<?php } ?>
</body>
